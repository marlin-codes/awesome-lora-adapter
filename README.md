...
- Convolution Meets LoRA: Parameter Efficient Finetuning for Segment Anything Model | [Code](https://github.com/autogluon/autogluon/tree/master/examples/automm/Conv-LoRA?utm_source=catalyzex.com) \
An Wang, Mobarakol Islam, Mengya Xu, Yang Zhang, Hongliang Ren 
...
hiheng Liu, Yifei Zhang, Yujun Shen, Kecheng Zheng, Kai Zhu, Ruili Feng, Yu Liu, Deli Zhao, Jingren Zhou, Yang Cao
...
Oscar Key, Jean Kaddour1, Pasquale Minervini 
